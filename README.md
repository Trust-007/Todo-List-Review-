...
You can check out the project using this [live demo link](https://trust-007.github.io/Todo-List-Review-/)
...
- Clone the repository using the following command: `git clone https://github.com/Trust-007/Todo-List-Review-.git
